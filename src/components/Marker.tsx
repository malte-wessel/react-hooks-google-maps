...
const Marker: FC<MarkerProps> = (props) => {
    ...
    useGoogleMapsEvent(map, 'animation_changed', onAnimationChanged);
    useGoogleMapsEvent(map, 'click', onClick);
    useGoogleMapsEvent(map, 'clickable_changed', onClickableChanged);
    useGoogleMapsEvent(map, 'cursor_changed', onCursorChanged);
    useGoogleMapsEvent(map, 'dblclick', onDoubleClick);
    useGoogleMapsEvent(map, 'drag', onDrag);
    useGoogleMapsEvent(map, 'dragend', onDragEnd);
    useGoogleMapsEvent(map, 'draggable_changed', onDraggableChanged);
    useGoogleMapsEvent(map, 'dragstart', onDragStart);
    useGoogleMapsEvent(map, 'flat_changed', onFlatChanged);
    useGoogleMapsEvent(map, 'icon_changed', onIconChanged);
    useGoogleMapsEvent(map, 'mousedown', onMouseDown);
    useGoogleMapsEvent(map, 'mouseout', onMouseOut);
    useGoogleMapsEvent(map, 'mouseover', onMouseOver);
    useGoogleMapsEvent(map, 'mouseup', onMouseUp);
    useGoogleMapsEvent(map, 'position_changed', onPositionChanged);
    useGoogleMapsEvent(map, 'rightclick', onRightClick);
    useGoogleMapsEvent(map, 'shape_changed', onShapeChanged);
    useGoogleMapsEvent(map, 'title_changed', onTitleChanged);
    useGoogleMapsEvent(map, 'visible_changed', onVisibleChanged);
